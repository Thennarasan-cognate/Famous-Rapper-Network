...
--
-- Host: localhost:3307
-- Generation Time: Sep 24, 2021 at 09:41 AM
...
--
-- Table structure for table `view-all-artists`
--

CREATE TABLE `view-all-artists` (
...
--
-- Indexes for table `view-all-artists`
--
ALTER TABLE `view-all-artists`
...
--
-- AUTO_INCREMENT for table `view-all-artists`
--
ALTER TABLE `view-all-artists`
