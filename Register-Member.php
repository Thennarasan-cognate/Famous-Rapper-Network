    ...
    <section class="u-clearfix u-section-1" id="sec-6065">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
          <!-- <form action="" method="post" class="u-clearfix u-form-spacing-24 u-form-vertical u-inner-form" source="custom" name="form-1" style="padding: 50px;"> -->
            <form action="" method="post" class="" source="custom" name="form-2" style="padding: 50px;">

            <input type="hidden" id="siteId" name="siteId" value="2470013253">
            <input type="hidden" id="pageId" name="pageId" value="867430778">
            ...
            <div class="u-form-group u-form-name u-form-group">
              <label for="name-cd60" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Enter your First Name" id="name-cd60" name="firstname" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            ...
            <div class="u-form-group u-form-group">
              ...
              <input type="text" placeholder="Enter your Last Name" id="text-0253" name="lastname" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
              <h6 class="text-center" style="color:#ff0000"><?php echo $message_Lastname; ?></h6>
            </div>
            <div class="u-form-group u-form-group">
              <label for="text-0253" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Enter your Phone Number" id="text-0253" name="phone" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            ...
            <div class="u-form-email u-form-group">
              ...
              <input type="email" placeholder="Enter a valid email address" id="email-cd60" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <br>
            <div class="u-form-group u-form-group">
              <label for="text-0f5e" class="u-form-control-hidden u-label"></label>
              <input type="password" id="text-0f5e" name="password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" placeholder="Enter New Passord">
            ...
            <div class="u-form-group u-form-group-5">
              ...
              <input type="password" placeholder="Confirm New Password" id="text-871f" name="confirm_password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
              <h6 class="text-center" style="color:#ff0000"><?php echo $message_cpassword; ?></h6>
            </div>
            <div class="u-align-center u-form-group u-form-submit">
              <a href="" class="u-border-none u-btn u-btn-submit u-button-style u-hover-palette-1-base u-palette-1-base u-btn-1">Register<br>
              </a>
<!--              <a href="" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-17 u-btn-1">Register</a>-->
